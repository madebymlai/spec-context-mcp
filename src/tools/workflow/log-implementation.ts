...
import { ToolContext, ToolResponse, ImplementationLogEntry } from '../../workflow-types.js';
import { PathUtils } from '../../core/workflow/path-utils.js';
import { ImplementationLogManager } from '../../storage/implementation-log-manager.js';
...
export const logImplementationTool: Tool = {
  ...
  description: `Log implementation, record what I built, save implementation details, document task completion. Use when user finishes implementing a task, wants to record what was built, or says "log this", "record implementation", "I finished task X".
    ...
    try {
      ...
      if (!taskExists) {
        return {
          ...
          nextSteps: [
            `Check the task ID in .spec-context/specs/${specName}/tasks.md`,
      ...
      return {
        ...
        nextSteps: [
          `Check that .spec-context/specs/${specName}/tasks.md exists`,
