...
const prompt: Prompt = {
  ...
  description: 'Check spec status, show my specs, list specifications, project progress, what specs exist. Use when user asks about spec status, wants to see all specs, check progress, or says "what specs do I have", "show spec progress", "list my specs".',
  arguments: [
    {
      name: 'specName',
...
2. If you need detailed task information, read the tasks.md file directly at .spec-context/specs/${specName}/tasks.md
3. Check for any pending approvals using approvals tool with action:'status'` :
  `1. List directory .spec-context/specs/ to see all specifications
