...
const prompt: Prompt = {
  ...
  description: 'Update tasks, refresh task list, sync tasks with requirements, realign tasks after changes. Use when requirements or design changed and tasks need updating, or user says "refresh tasks", "update task list", "sync tasks".',
  arguments: [
    {
      name: 'specName',
