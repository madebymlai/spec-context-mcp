...
function SpecCard({ spec, onOpenModal, isArchived }: { spec: any; onOpenModal: (spec: any) => void; isArchived: boolean }) {
  ...
  const handleViewSpec = (e: React.MouseEvent) => {
    e.stopPropagation();
    onOpenModal(spec);
  };
  ...
  return (
    <div 
      className={`bg-white dark:bg-gray-800 shadow rounded-lg transition-all ${
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-lg transition-colors text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700/50"
              title="View spec"
